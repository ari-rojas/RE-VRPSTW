...
public class CCRLabel{
	...
	/** Creates a new Label.*/
	public CCRLabel(int nextLabelIndex, double reducedCost, int remainingLoad, int remainingTime, int[] remainingEnergy, int chargingTime, boolean[] unreachable, boolean[] ng_path, boolean[] eta, HashSet<Integer> srcIndices) {
	...
	public CCRLabel clone(){
		
		CCRLabel newLab = new CCRLabel(this.nextLabelIndex, this.reducedCost, this.remainingLoad, this.remainingTime, this.remainingEnergy, this.chargingTime, this.unreachable, this.ng_path, this.eta, this.srcIndices);
	...
	public static class SortLabels implements Comparator<CCRLabel> {
		...
		@Override
		public int compare(CCRLabel L1, CCRLabel L2) {
