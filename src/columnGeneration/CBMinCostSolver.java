 ...
 */
public final class CBMinCostSolver extends AbstractPricingProblemSolver<EVRPTW, Route, PricingProblem> {
	 ...
	 */
	public CBMinCostSolver(EVRPTW dataModel, PricingProblem pricingProblem) {
