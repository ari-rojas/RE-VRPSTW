 ...
 */
public final class CBHeuristicSolver extends AbstractPricingProblemSolver<EVRPTW, Route, PricingProblem> {
	...
	public CBHeuristicSolver(EVRPTW dataModel, PricingProblem pricingProblem) {
