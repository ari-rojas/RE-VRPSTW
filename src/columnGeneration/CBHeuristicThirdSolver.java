 ...
 */
public final class CBHeuristicThirdSolver extends AbstractPricingProblemSolver<EVRPTW, Route, PricingProblem> {
	 ...
	 */
	public CBHeuristicThirdSolver(EVRPTW dataModel, PricingProblem pricingProblem) {
